...
import type { IEventPayment } from "../model/payment";
import CustomButton from "./shared/customButton";
// import { useParams } from "react-router-dom";

interface CheckoutFormProps {
  formData: IEventPayment;
  finalAmount?: number;
  paymentFee?: number;
  setTab?: any
}
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const payload: {
        ...
        "numberOfTickets": props?.formData?.numberOfTickets,
        "ticketTypeId": props?.formData?.ticketTypeId,
      }; 
