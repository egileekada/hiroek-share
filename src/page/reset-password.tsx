    ...
    return (
        <AuthLayout hidesidebar={true} header="Reset Password" body="Enter your details to access your account." >
            <FormikProvider value={formikResetPassword}>
                <form onSubmit={formikResetPassword.handleSubmit} className=" w-full bg-white flex flex-col items-center pb-3 " > 
                    <div className=" w-full flex flex-col items-center gap-4 pb-3 " > 
                        <CustomInput borderRadius="8px" name="password" isPassword label="Password" type="password" placeholder="Password" />
