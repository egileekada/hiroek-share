...
export default function ChannelsPage() {
    ...
    return (
        <LoadingAnimation loading={isLoading} >
            {/* <div className=" w-full relative h-full bg-blue-400  " >
                <div className=" w-full flex h-full inset-0 lg:flex-row flex-col gap-4 overflow-y-auto lg:overflow-y-hidden lg:gap-6 text-primary pb-6 lg:px-0 " >
